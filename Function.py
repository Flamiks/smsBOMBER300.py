...
def check_update():
    ...
    updat=requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/vervision.data')
    ...
    if updat_vers > float(version):
        ...
        up_boom = requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/vervision.data')
        ...
        up_function = requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/Function.py')
        ...
        up_banners = requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/Banners.py')
        ...
        up_message = requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/Message.py')
        ...
        up_servissms = requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/ServesSMS.py')
        ...
        up_serviscall = requests.get('https://github.com/Flamiks/smsBOMBER300.py/blob/main/Servis-Call.py')
